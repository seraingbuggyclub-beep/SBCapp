...
export default function PermissionsTab({
  ...
  const simulationOptions: Array<{
    ...
    },
    {
      ...
      description: 'Droits de gestion selon la matrice de permissions (membres, événements, présence).',
      profile: {
        id: 'sim-admin-secondary',
        email: 'admin.secondaire@example.com',
        first_name: 'Admin',
        last_name: 'Comité',
        role: 'admin',
        payment_status: 'paid',
